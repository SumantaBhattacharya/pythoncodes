...
print(queue)
queue.pop(0)
print("The first element to be poped out:",queue)
queue.pop(0)#The only differences here we are eliminating the elements by its index
queue.pop(0)
print(queue)

print((queue[-1]))# Last entered element this both of the code works
print((queue[0]))#  first entered element
